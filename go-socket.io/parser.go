...
func (e *encoder) Encode(v packet) error {
	...
	//fmt.Println(">>>>>>>>>>>>>>> Encode", attachments, len(attachments))
...
func (d *decoder) Decode(v *packet) error {
	...
	//fmt.Println(">>>>>>>>>>>>>>Read Byte Packet", r)
	...
	if err != nil {
		//		fmt.Println(">>>>>>>>>>>>>>Read Byte err", err, t)
		return err
	}

	//	fmt.Println(">>>>>>>>>>>>>>>>>Read Byte", t)
	...
	//	fmt.Println(">>>>>>>>>>>>>>>>>Read Byte Vtype", v.Type)
