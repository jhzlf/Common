...
import (
	...
	"Common/go-engine.io/polling"
	"Common/go-engine.io/websocket"
)

const (
	GOTYE_ENGINEIO_DEBUG_LOG = false
)
...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if GOTYE_ENGINEIO_DEBUG_LOG {
		fmt.Println(">>>>>>>>>>>>>>ServerHttp Working", r.Header, r.RequestURI)
	}
	...
	if GOTYE_ENGINEIO_DEBUG_LOG {
		//fmt.Println(">>>>>>>>>>>>>> Send to conn.ServeHttp")
	}
